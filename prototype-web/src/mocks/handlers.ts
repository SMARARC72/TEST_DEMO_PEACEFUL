    ...
    return mockJson([
      {
        ...
        dateTime: new Date(now + 3 * 86400000).toISOString(),
        duration: 50,
      ...
      },
      {
        ...
        clinicianId: 'clinician-001',
        clinicianName: 'Dr. Sarah Chen',
        type: 'MEDICATION_MANAGEMENT' as const,
        status: 'COMPLETED' as const,
        dateTime: new Date(now - 7 * 86400000).toISOString(),
        duration: 30,
    ...
    return mockJson([
      {
        ...
        diagnosedDate: '2025-01-20T00:00:00Z',
        status: 'ACTIVE' as const,
      },
      {
        id: 'dx-002',
