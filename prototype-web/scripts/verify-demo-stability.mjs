...
const pageFiles = [
  ...
  'src/pages/patient/WelcomePage.tsx',
  'src/pages/patient/ConsentPage.tsx',
  'src/pages/patient/VoiceMemoPage.tsx',
  'src/pages/patient/SafetyPlanPage.tsx',
  'src/pages/patient/ResourcesPage.tsx',
  'src/pages/patient/SettingsPage.tsx',
