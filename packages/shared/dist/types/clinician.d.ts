...
export declare enum ClinicianRole {
    CLINICIAN = "CLINICIAN",
    SUPERVISOR = "SUPERVISOR",
    ADMIN = "ADMIN"
}
/** Triage queue item status. */
export declare enum TriageStatus {
    ACK = "ACK",
    IN_REVIEW = "IN_REVIEW",
    ESCALATED = "ESCALATED",
    RESOLVED = "RESOLVED"
...
export declare enum DraftFormat {
    SOAP = "SOAP",
    NARRATIVE = "NARRATIVE",
...
export declare enum MBCInstrument {
    PHQ9 = "PHQ9",
    GAD7 = "GAD7"
}
/** Score trend direction. */
export declare enum ScoreTrend {
    UP = "UP",
    DOWN = "DOWN",
    STABLE = "STABLE"
}
...
export declare enum EscalationTier {
    T2 = "T2",
    T3 = "T3"
}
